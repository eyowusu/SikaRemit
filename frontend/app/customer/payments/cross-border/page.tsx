...
export default function CrossBorderRemittancePage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-6">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Complete International Transfer</h1>
              <p className="text-muted-foreground">Review and complete your cross-border money transfer</p>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Send Internationally</h1>
              <p className="text-muted-foreground">Transfer money across borders securely</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/50 dark:bg-slate-800/50 rounded-lg p-6 backdrop-blur-sm">
          <h3 className="font-semibold mb-4">Exchange Rates & Fees</h3>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div>
              <div className="text-muted-foreground">Transfer Fee</div>
              <div className="font-semibold">1.5% - 3.5%</div>
            </div>
            <div>
              <div className="text-muted-foreground">Processing Time</div>
              <div className="font-semibold">1-3 business days</div>
            </div>
            <div>
